...
def main():
    ...
    parser.add_argument('--include', '-n', help="Functions to Include (file containig a list)", default=None)
    parser.add_argument('--exclude', '-x', help="Functions to Exclude (file containig a list)", default=None)
